...
public class CheckoutZeroProduct {
	ExtentReports extent = new ExtentReports();
	ExtentSparkReporter spark = new ExtentSparkReporter("report_zero_product.html");
	...
	public void login() throws InterruptedException {
		...
		ExtentTest oneprod = extent.createTest("User Add Zero Product");
